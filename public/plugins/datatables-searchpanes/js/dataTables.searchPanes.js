...
;(function () {
  ...
  var SearchPane = /** @class */ (function () {
    ...
    SearchPane.prototype.adjustTopRow = function () {
      ...
      if (
        ($$4(subContainers[0]).width() < 252 || $$4(topRow[0]).width() < 252) &&
        $$4(subContainers[0]).width() !== 0
      ) {
  ...
  var SearchPanes = /** @class */ (function () {
    function SearchPanes(paneSettings, opts, fromPreInit, paneClass) {
      ...
      this.dom = {
        ...
        container: $('<div/>')
          ...
          .html(table.i18n('searchPanes.loadMessage', this.c.i18n.loadMessage)),
    ...
    SearchPanes.prototype.resizePanes = function () {
      if (this.c.layout === 'auto') {
        ...
        var widerIndexes_1 =
          highestmod_1 !== 0
            ? dispIndex.slice(dispIndex.length - highestmod_1, dispIndex.length)
            : []
    ...
    SearchPanes.prototype._setCollapseListener = function () {
      ...
      for (var _i = 0, _a = this.s.panes; _i < _a.length; _i++) {
        ...
        pane.dom.collapseButton.on('click.dtsps', function () {
          ...
          .on('preXhr.dtsps', function (e, settings, data) {
            ...
            if (_this.s.selectionList.length > 0) {
              data.searchPanesLast = _this.s.dt
                .column(
                  _this.s.selectionList[_this.s.selectionList.length - 1].column
                )
                .dataSrc()
            }
          })
  ...
  var SearchPanesST = /** @class */ (function (_super) {
      ...
      for (var _i = 0, _a = this.s.panes; _i < _a.length; _i++) {
        ...
        if (pane.s.colOpts.show) {
          ...
          if (this.s.serverData.searchPanes.options[colTitle]) {
            for (
              var _b = 0, _c = this.s.serverData.searchPanes.options[colTitle];
              _b < _c.length;
              _b++
            ) {
              var data = _c[_b]
    ...
    SearchPanesST.prototype._updateSelectionList = function (paneIn) {
      ...
      if (paneIn !== undefined) {
        ...
        this.s.selectionList = this.s.selectionList.filter(function (
          selection
        ) {
