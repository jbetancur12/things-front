...
$jscomp.polyfill = function (l, n, k, q) {
  n &&
    ($jscomp.ISOLATE_POLYFILLS
      ? $jscomp.polyfillIsolated(l, n, k, q)
      : $jscomp.polyfillUnisolated(l, n, k, q))
}
$jscomp.polyfillUnisolated = function (l, n, k, q) {
  ...
  n != q &&
    null != n &&
    $jscomp.defineProperty(k, l, { configurable: !0, writable: !0, value: n })
}
...
$jscomp.polyfill(
  ...
  function (l) {
    ...
    q.prototype.set = function (r, p) {
      ...
      u.entry
        ...
        : ((u.entry = {
          ...
          u.list.push(u.entry),
          (this.head_.previous.next = u.entry),
          (this.head_.previous = u.entry),
          this.size++)
      return this
    }
    ...
    q.prototype.forEach = function (r, p) {
      for (var u = this.entries(), y; !(y = u.next()).done; )
        (y = y.value), r.call(p, y[1], y[0], this)
    }
    ...
    var v = function (r, p) {
        ...
        if (y && $jscomp.owns(r.data_, u))
          for (r = 0; r < y.length; r++) {
            var E = y[r]
            if ((p !== p && E.key !== E.key) || p === E.key)
              return { id: u, list: y, index: r, entry: E }
          }
      ...
      B = function (r, p) {
        ...
        return $jscomp.iteratorPrototype(function () {
          if (u) {
            ...
            for (; u.next != u.head; )
              return (u = u.next), { done: !1, value: p(u) }
            u = null
          }
  ...
  function (l) {
    return l
      ...
      : function (n, k) {
          return (
            -1 !==
            $jscomp.checkStringArgs(this, n, 'includes').indexOf(n, k || 0)
          )
        }
  },
  'es6',
...
;(function () {
  ...
  var k,
    ...
    v = (function () {
      function h(b, a, c, d, e) {
        ...
        this.dom = {
          ...
          container: k('<div/>')
            ...
            .addClass(
              this.classes.layout +
                (10 > parseInt(this.c.layout.split('-')[1], 10)
                  ? this.c.layout
          ...
          countButton: k('<button type="button"></button>')
            .addClass(this.classes.paneButton)
          ...
          nameButton: k('<button type="button"></button>')
            .addClass(this.classes.paneButton)
          ...
          searchButton: k('<button type = "button"/>')
        ...
        this.s.searchFunction = function (m, t, w) {
          ...
          f.s.colExists &&
            ((m = t[f.s.index]),
            'filter' !== f.s.colOpts.orthogonal.filter &&
              ((m = f.s.rowData.filterMap.get(w)),
              m instanceof k.fn.dataTable.Api && (m = m.toArray())))
        ...
        if (this.c.clear)
          this.dom.clear.on('click.dtsp', function () {
            f.dom.container
              .find('.' + f.classes.search.replace(/\s+/g, '.'))
              .each(function () {
      ...
      h.prototype.addRow = function (b, a, c, d, e, f, g) {
        ...
        void 0 === m &&
          ((m = this.s.indexes.length),
          this.s.indexes.push({ filter: a, index: m }))
      ...
      h.prototype.adjustTopRow = function () {
        ...
        ;(252 > k(b[0]).width() || 252 > k(d[0]).width()) &&
        0 !== k(b[0]).width()
          ? (k(b[0]).addClass(this.classes.narrow),
            k(a[0])
          ...
          : (k(b[0]).removeClass(this.classes.narrow),
            k(a[0])
      ...
      h.prototype.destroy = function () {
        ...
        for (
          var b = k.fn.dataTable.ext.search.indexOf(this.s.searchFunction);
          -1 !== b;

        )
          k.fn.dataTable.ext.search.splice(b, 1),
            (b = k.fn.dataTable.ext.search.indexOf(this.s.searchFunction))
      ...
      h.prototype.rebuildPane = function (b, a) {
        ...
        this.s.displayed = !1
        this._buildPane(
          this.s.dt.page.info().serverSide ? this.s.serverSelect : c,
          b,
          d
        )
        return this
      ...
      h.prototype.resize = function (b) {
        ...
        this.dom.container
          ...
          .addClass(
            this.classes.layout +
              (10 > parseInt(b.split('-')[1], 10) ? b : b.split('-')[0] + '-9')
          )
          .addClass(
      ...
      h.prototype.setListeners = function () {
        ...
        this.s.dtPane &&
          ...
          this.s.dtPane.off('select.dtsp').on('select.dtsp', function () {
            ...
            b.dom.clear
              .removeClass(b.classes.disabledButton)
              .removeAttr('disabled')
          }),
          this.s.dtPane.off('deselect.dtsp').on('deselect.dtsp', function () {
            b.s.deselectTimeout = setTimeout(function () {
              b._updateSelection(!0)
              0 === b.s.dtPane.rows({ selected: !0 }).data().toArray().length &&
                b.dom.clear
                  .addClass(b.classes.disabledButton)
                  .attr('disabled', 'true')
            }, 50)
          }),
          this.s.firstSet &&
            ...
            this.s.dt.on('stateSaveParams.dtsp', function (a, c, d) {
              if (k.isEmptyObject(d)) b.s.dtPane.state.clear()
                ...
                for (c = 0; c < d.searchPanes.panes.length; c++)
                  d.searchPanes.panes[c].id === b.s.index &&
                    (d.searchPanes.panes.splice(c, 1), c--)
          ...
          this.s.dtPane
            ...
            .on('user-select.dtsp', function (a, c, d, e, f) {
              f.stopPropagation()
            }),
          ...
          this.dom.clear.off('click.dtsp').on('click.dtsp', function () {
            b.dom.container
              .find('.' + b.classes.search.replace(/ /g, '.'))
              .each(function () {
                k(this).val('').trigger('input')
              })
            b.clearPane()
      ...
      h.prototype._serverPopulate = function (b) {
        if (b.tableLength)
          (this.s.tableLength = b.tableLength),
        ...
        if (b.searchPanes.options[a]) {
          var c = 0
          for (b = b.searchPanes.options[a]; c < b.length; c++)
            (a = b[c]),
        ...
        ((void 0 === this.s.colOpts.show && null === this.s.colOpts.threshold
          ? b > this.c.threshold
          : b > this.s.colOpts.threshold) ||
          (!0 !== this.s.colOpts.show && 1 >= c))
          ...
          for (var e = 0; e < b.length; e++) {
            ...
            if ('function' === typeof f.value) {
              for (var x = 0; x < c.length; x++)
                f.value.call(this.s.dt, c[x], a[0][x]) && z++
      ...
      h.prototype._populatePaneArray = function (b, a, c, d) {
        ...
        if ('string' === typeof this.s.colOpts.orthogonal)
          (c = c.oApi._fnGetCellData(
            ...
            this.s.rowData.filterMap.set(b, c),
            this._addOption(c, c, c, c, a, d)
        else {
          var e = c.oApi._fnGetCellData(
            c,
            b,
            this.s.index,
        ...
        if (Array.isArray(b) || b instanceof q.Api)
          ...
          'string' === typeof this.s.colOpts.orthogonal
            ? (f[b]
                ? f[b]++
                : ((f[b] = 1),
                  e.push({ display: a, filter: b, sort: c, type: d })),
              this.s.rowData.totalOptions++)
            : e.push({ display: a, filter: b, sort: c, type: d })
      }
      h.prototype._buildPane = function (b, a, c) {
        ...
        if (this.s.colExists) {
          ...
          if (
            this.s.dt.page.info().serverSide ||
            (a && a.searchPanes && a.searchPanes.options)
          )
            a &&
              a.searchPanes &&
              a.searchPanes.options &&
              this._serverPopulate(a)
          else {
            ...
            if (
              ...
              null === this.s.colOpts.threshold
                ? f > this.c.threshold
                : f > this.s.colOpts.threshold) ||
                (!0 !== this.s.colOpts.show && 1 >= g))
            ) {
              this.dom.container.addClass(this.classes.hidden)
              this.s.displayed = !1
              return
        ...
        null !== c && 0 < this.dom.panesContainer.has(c).length
          ? this.dom.container.insertAfter(c)
        ...
        this.s.customPaneSettings && this.s.customPaneSettings.header
          ...
          : this.s.colExists &&
            (g = k.fn.dataTable.versionCheck('2')
        ...
        if (this.s.colExists)
          for (g = 0, f = this.s.rowData.arrayFilter.length; g < f; g++)
            if (this.s.dt.page.info().serverSide) {
              c = this.addRow(
                this.s.rowData.arrayFilter[g].display,
                this.s.rowData.arrayFilter[g].filter,
                this.s.rowData.arrayFilter[g].sort,
                this.s.rowData.arrayFilter[g].type
              )
              for (var m = 0, t = this.s.serverSelect; m < t.length; m++)
                t[m].filter === this.s.rowData.arrayFilter[g].filter &&
                  ((this.s.serverSelecting = !0),
                  c.select(),
                  (this.s.serverSelecting = !1))
            } else
        ...
        for (g = 0; g < b.length; g++)
          if ((f = b[g]))
            for (
              m = 0, t = this.s.dtPane.rows().indexes().toArray();
              m < t.length;
              m++
            )
              (c = t[m]),
        ...
        if (e && e.searchPanes && e.searchPanes.panes && (!a || 1 === a.draw))
          for (
            this._reloadSelect(e), a = 0, e = e.searchPanes.panes;
            a < e.length;
            a++
          )
            (b = e[a]),
      ...
      h.prototype._populatePane = function () {
        ...
        if (!this.s.dt.page.info().serverSide)
          for (
            var a = 0, c = this.s.dt.rows().indexes().toArray();
            a < c.length;
            a++
          )
            this._populatePaneArray(c[a], this.s.rowData.arrayFilter, b)
      }
      h.prototype._search = function (b, a) {
        for (
          var c = this.s.colOpts, d = this.s.dt, e = 0, f = this.s.selections;
          e < f.length;
          e++
        ) {
          var g = f[e]
          ...
          if (Array.isArray(b))
            ...
            b === g ||
            (('string' !== typeof b || 0 !== b.length) && b == g) ||
            (null === g && 'string' === typeof b && '' === b)
          )
            return !0
        }
      ...
      h.prototype._searchExtras = function () {
        ...
        0 < a.length
          ...
          : 0 === a.length && d.removeClass(this.classes.selected)
        this.s.updating = b
      }
      h.version = '2.0.0-dev'
      h.classes = {
    ...
    C = (function (h) {
      ...
      b.prototype._serverPopulate = function (a) {
        ...
        if (
          ...
          ((void 0 === this.s.colOpts.show && null === this.s.colOpts.threshold
            ? a > this.c.threshold
            : a > this.s.colOpts.threshold) ||
            (!0 !== this.s.colOpts.show && 1 >= d))
        )
          this.dom.container.addClass(this.classes.hidden),
            (this.s.displayed = !1)
        else if (
          ...
          for (e = 0; e < d.length; e++)
            for (
              m = d[e], f = 0, g = this.s.rowData.arrayOriginal;
              f < g.length;
              f++
            )
              (a = g[f]),
      ...
      b.prototype.updateRows = function () {
        if (!this.s.dt.page.info().serverSide) {
          ...
          for (
            var a = 0,
              c = this.s.dt.rows({ search: 'applied' }).indexes().toArray();
            a < c.length;
            a++
          )
            this._updateShown(
        ...
        for (c = this.s.dtPane.rows().data().toArray(); a < c.length; a++) {
          var d = c[a]
          d.shown =
            'number' === typeof this.s.rowData.binsShown[d.filter]
              ? this.s.rowData.binsShown[d.filter]
              : 0
    ...
    p = (function (h) {
      function b(a, c, d, e, f) {
        return (
          h.call(
            this,
            a,
            r.extend({ i18n: { countFiltered: '{shown} ({total})' } }, c),
            d,
            e,
            f
          ) || this
      ...
      b.prototype._getMessage = function (a) {
        ...
        return (this.s.filteringActive ? d : c)
          .replace(/{total}/g, a.total)
          .replace(/{shown}/g, a.shown)
      }
      b.prototype._getShown = function (a) {
        return this.s.rowData.binsShown && this.s.rowData.binsShown[a]
          ? this.s.rowData.binsShown[a]
          : 0
      }
      return b
    })(C),
    ...
    E = (function (h) {
      ...
      b.prototype.updateRows = function () {
        ...
        if (
          ...
          this._getComparisonRows()
          for (
            var c = this.s.dtPane.rows().toArray()[0], d = 0;
            d < c.length;
            d++
          ) {
            ...
            if (void 0 !== f)
              if (0 === f.shown)
                e.remove(), (c = this.s.dtPane.rows().toArray()[0]), d--
              else
          ...
          if (!this.s.dt.page.info().serverSide)
            for (
              this._activePopulatePane(),
                this.s.rowData.binsShown = {},
                e = 0,
                t = this.s.dt.rows({ search: 'applied' }).indexes().toArray();
              e < t.length;
              e++
            )
              this._updateShown(
          ...
          for (g = this.s.rowData.arrayFilter; f < g.length; f++)
            if (((c = g[f]), 0 !== c.shown))
              for (
                e = this.addRow(c.display, c.filter, c.sort, c.type, void 0),
                  d = 0;
                d < a.length;
                d++
              )
          ...
          for (d = 0; d < a.length; d++)
            for (
              t = a[d], f = 0, g = this.s.rowData.arrayOriginal;
              f < g.length;
              f++
            )
              (c = g[f]),
      ...
      b.prototype._activePopulatePane = function () {
        ...
        if (!this.s.dt.page.info().serverSide)
          for (
            var c = 0,
              d = this.s.dt.rows({ search: 'applied' }).indexes().toArray();
            c < d.length;
            c++
          )
            this._populatePaneArray(d[c], this.s.rowData.arrayFilter, a)
      }
      b.prototype._getComparisonRows = function () {
        var a = this.s.colOpts.options
          ? this.s.colOpts.options
          : this.s.customPaneSettings && this.s.customPaneSettings.options
          ? this.s.customPaneSettings.options
          : void 0
          ...
          for (var m = 0; m < a.length; m++) {
            ...
            if ('function' === typeof t.value) {
              for (var F = 0; F < e.length; F++)
                t.value.call(this.s.dt, e[F], c[0][F]) && M++
              for (F = 0; F < f.length; F++)
                t.value.call(this.s.dt, f[F], d[0][F]) && L++
    ...
    I = (function () {
      function h(b, a, c, d) {
        ...
        void 0 === c && (c = !1)
        void 0 === d && (d = v)
        if (!G || !G.versionCheck || !G.versionCheck('1.10.0'))
          throw Error('SearchPane requires DataTables 1.10 or newer')
        ...
        this.dom = {
          clearAll: D('<button type="button"/>')
            .addClass(this.classes.clearAll)
            .html(f.i18n('searchPanes.clearMessage', this.c.i18n.clearMessage)),
          collapseAll: D('<button type="button"/>')
            .addClass(this.classes.collapseAll)
            .html(
              f.i18n('searchPanes.collapseMessage', this.c.i18n.collapseMessage)
            ),
          container: D('<div/>')
            .addClass(this.classes.panes)
            .html(f.i18n('searchPanes.loadMessage', this.c.i18n.loadMessage)),
          emptyMessage: D('<div/>').addClass(this.classes.emptyMessage),
          panes: D('<div/>').addClass(this.classes.container),
          showAll: D('<button type="button"/>')
            .addClass(this.classes.showAll)
            .addClass(this.classes.disabledButton)
            .attr('disabled', 'true')
            .html(f.i18n('searchPanes.showMessage', this.c.i18n.showMessage)),
            ...
            this.s.dt.on('preXhr.dtsps', function (m, t, w) {
              if (g === t) {
                ...
                for (t = e.s.selectionList; m < t.length; m++) {
                  ...
                  void 0 === w.searchPanes_null[z] &&
                    (w.searchPanes_null[z] = {})
                  for (var x = 0; x < A.rows.length; x++)
                    (w.searchPanes[z][x] = A.rows[x]),
                      null === w.searchPanes[z][x] &&
                        (w.searchPanes_null[z][x] = !0)
                }
      ...
      h.prototype.clearSelections = function () {
        for (var b = 0, a = this.s.panes; b < a.length; b++) {
          var c = a[b]
          c.s.dtPane &&
            (c.s.scrollTop = c.s.dtPane.table().node().parentNode.scrollTop)
        }
        this.dom.container
        ...
        b = []
        a = 0
        for (var d = this.s.panes; a < d.length; a++)
          (c = d[a]), c.s.dtPane && b.push(c.clearPane())
        return b
      }
      ...
      h.prototype.resizePanes = function () {
        if ('auto' === this.c.layout) {
          ...
          this.s.panes.forEach(function (t) {
            t.s.displayed &&
              t.resize('columns-' + (m.includes(t.s.index) ? d : c))
          })
        } else
          for (b = 0, a = this.s.panes; b < a.length; b++)
            (g = a[b]), g.adjustTopRow()
        return this
      }
        ...
        var b = this,
          ...
          c = function (d) {
            d &&
              ...
              ((b.s.serverData = d),
              (b.s.serverData.tableLength = d.recordsTotal),
              b._serverTotals())
          }
      ...
      h.prototype._stateLoadListener = function () {
        ...
        this.s.dt.on('stateLoadParams.dtsps', function (a, c, d) {
          if (void 0 !== d.searchPanes) {
            b.clearSelections()
            b.s.selectionList = d.searchPanes.selectionList
              ? d.searchPanes.selectionList
              : []
            if (d.searchPanes.panes)
              for (a = 0, d = d.searchPanes.panes; a < d.length; a++) {
                ...
                for (var e = 0, f = b.s.panes; e < f.length; e++) {
                  ...
                  c.id === g.s.index &&
                    g.s.dtPane &&
                    (g.dom.searchBox.val(c.searchTerm),
      ...
      h.prototype._updateSelection = function () {
        ...
        for (var b = 0, a = this.s.panes; b < a.length; b++) {
          ...
          if (c.s.dtPane) {
            ...
            d.length &&
              this.s.selectionList.push({ column: c.s.index, rows: d })
          }
        }
      }
      h.prototype._attach = function () {
        ...
        for (var a = 0, c = this.s.panes; a < c.length; a++)
          this.dom.panes.append(c[a].dom.container)
        this.dom.container
          .text('')
          .removeClass(this.classes.hide)
        ...
        0 === D('div.' + this.classes.container).length &&
          this.dom.container.prependTo(this.s.dt)
      }
      h.prototype._attachMessage = function () {
        try {
          var b = this.s.dt.i18n(
        ...
        null === b
          ...
          : (this.dom.container.removeClass(this.classes.hide),
            ...
            this.dom.emptyMessage.html(b).appendTo(this.dom.container))
      }
      ...
      h.prototype._getState = function () {
        ...
        b &&
          b.searchPanes &&
          b.searchPanes.selectionList &&
          (this.s.selectionList = b.searchPanes.selectionList)
      }
      h.prototype._makeSelections = function (b) {
        for (var a = 0; a < b.length; a++) {
          for (
            var c = b[a], d = void 0, e = 0, f = this.s.panes;
            e < f.length;
            e++
          ) {
            var g = f[e]
          ...
          if (d && d.s.dtPane) {
            for (e = 0; e < d.s.dtPane.rows().data().toArray().length; e++)
              c.rows.includes(
                'function' === typeof d.s.dtPane.row(e).data().filter
                  ? d.s.dtPane.cell(e, 0).data()
                  : d.s.dtPane.row(e).data().filter
              ) && d.s.dtPane.row(e).select()
            d.updateTable()
          }
        }
      }
      h.prototype._paneDeclare = function (b, a, c) {
        ...
        for (
          var e = b.columns().eq(0).toArray().length, f = 0;
          f < this.c.panes.length;
          f++
        )
          this.s.panes.push(
            new this.s.paneClass(a, c, e + f, this.dom.panes, this.c.panes[f])
          )
      ...
      h.prototype._startup = function (b) {
        ...
        !this.s.stateRead &&
          c &&
          this.s.dt.page(c.start / this.s.dt.page.len()).draw('page')
        this.s.stateRead = !0
        this._checkMessage()
        b.on('preDraw.dtsps', function () {
          a.s.updating ||
            a.s.paging ||
            (a._updateFilterCount(), a._updateSelection())
          a.s.paging = !1
        })
        D(window).on(
          'resize.dtsps',
        ...
        b.off('page.dtsps page-nc.dtsps').on(
          'page.dtsps page-nc.dtsps',
          function (f, g) {
            a.s.paging = !0
            a.s.pagingST = !0
            ...
            for (var t = a.s.panes; g < t.length; g++) {
              ...
              if (w.s.dtPane) {
                ...
                for (var z = 0; z < w.length; z++)
                  (m.searchPanes[A][z] = w[z].filter),
                    m.searchPanes[A][z] || (m.searchPanes_null[A][z] = !0),
                    f++
              }
            }
            0 < f &&
              (f !== a.s.filterCount
                ? ((m.start = 0), (a.s.page = 0))
                : (m.start = a.s.page * a.s.dt.page.len()),
              a.s.dt.page(a.s.page),
              (a.s.filterCount = f))
            0 < a.s.selectionList.length &&
              (m.searchPanesLast = a.s.dt
                .column(a.s.selectionList[a.s.selectionList.length - 1].column)
                .dataSrc())
          })
        else
        ...
        this.s.dt.on('xhr.dtsps', function (f, g) {
          if (
            g.nTable === a.s.dt.table().node() &&
            !a.s.dt.page.info().serverSide
          ) {
            var m = !1
        ...
        c &&
          c.searchPanes &&
          c.searchPanes.selectionList &&
          (d = c.searchPanes.selectionList)
      ...
      h.prototype._updateFilterCount = function () {
        ...
        this.dom.title.html(
          this.s.dt.i18n('searchPanes.title', this.c.i18n.title, b)
        )
    ...
    K = (function (h) {
      function b(a, c, d) {
        ...
        e.s.dt.off('init.dtsps').on('init.dtsps', function () {
          return e._initSelectionListeners(
            !0,
            g && g.searchPanes && g.searchPanes.selectionList
              ? g.searchPanes.selectionList
              : e.c.preSelect
          )
        })
        return e
      ...
      b.prototype._initSelectionListeners = function (a, c) {
        ...
        for (c = this.s.panes; a < c.length; a++) {
          ...
          if (d.s.displayed)
            d.s.dtPane
              .off('select.dtsp')
              .on('select.dtsp', this._update(d))
              .off('deselect.dtsp')
              .on('deselect.dtsp', this._updateTimeout(d))
        }
        ...
        for (var a = 0, c = this.s.panes; a < c.length; a++) {
          ...
          if (d.s.colOpts.show) {
            ...
            if (this.s.serverData.searchPanes.options[e]) {
              var g = 0
              for (
                e = this.s.serverData.searchPanes.options[e];
                g < e.length;
                g++
              ) {
                var m = e[g]
        ...
        var a = this,
          c = function (d, e, f) {
            if (void 0 !== f.searchPanes) {
              a.s.selectionList = f.searchPanes.selectionList
                ? f.searchPanes.selectionList
                : []
              if (f.searchPanes.panes)
                for (d = 0, f = f.searchPanes.panes; d < f.length; d++) {
                  ...
                  for (var g = 0, m = a.s.panes; g < m.length; g++) {
                    ...
                    e.id === t.s.index &&
                      t.s.dtPane &&
                      (t.dom.searchBox.val(e.searchTerm),
                      t.s.dtPane.order(e.order))
                  }
                }
      ...
      b.prototype._updateSelectionList = function (a) {
        ...
        if (this.s.pagingST) this.s.pagingST = !1
          ...
          if (void 0 !== a) {
            ...
            0 < c.length
              ? (this.s.selectionList.push({ column: a.s.index, rows: c }),
                a.dom.clear
                  .removeClass(this.classes.disabledButton)
                  .removeAttr('disabled'))
              : a.dom.clear
      ...
      b.prototype._remakeSelections = function () {
        ...
        if (this.s.dt.page.info().serverSide) {
          ...
          for (var a = 0, c = this.s.panes; a < c.length; a++)
            (x = c[a]),
              !x.s.displayed || (e && x.s.index === e.s.index) || x.updateRows()
        } else {
            ...
            if (e.s.dtPane) {
              ...
              if (0 !== x.rows.length) {
                ...
                for (t = this.s.panes; m < t.length; m++)
                  (x = t[m]),
                    x.s.displayed &&
                      (a || e.s.index !== x.s.index || !g
                        ? (x.s.filteringActive = g || a)
                        : 1 === f && (x.s.filteringActive = !1),
                      x.s.index !== e.s.index && x.updateRows())
              }
            }
          }
          this.s.dt.draw()
  ...
  ;(function (h) {
    ...
    function c(e, f, g) {
      ...
      return (
        f && (f.cascadePanes || f.viewTotal) ? new K(e, f, g) : new I(e, f, g)
      ).getNode()
    }
    l(h)
    n(h)
    ...
    h.fn.dataTable.ext.buttons.searchPanes = {
      ...
      init: function (e, f, g) {
            ...
            filterChanged: function (t) {
              e.button(f).text(
                e.i18n(
                  ...
                  void 0 !== e.context[0].oLanguage.searchPanes
                    ? e.context[0].oLanguage.searchPanes.collapse
                    : e.context[0]._searchPanes.c.i18n.collapse,
                  t
                )
              )
            }
        ...
        m =
          m && (m.cascadePanes || m.viewTotal)
            ? new h.fn.dataTable.SearchPanesST(e, m)
            : new h.fn.dataTable.SearchPanes(e, m)
        e.button(f).text(
          g.text || e.i18n('searchPanes.collapse', m.c.i18n.collapse, 0)
        )
        g._panes = m
      },
      text: null
    ...
    h(a).on('preInit.dt.dtsp', function (e, f) {
      'dt' === e.namespace &&
        (f.oInit.searchPanes || d.defaults.searchPanes) &&
