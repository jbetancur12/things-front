...
$jscomp.polyfill = function (k, n, m, h) {
  n &&
    ($jscomp.ISOLATE_POLYFILLS
      ? $jscomp.polyfillIsolated(k, n, m, h)
      : $jscomp.polyfillUnisolated(k, n, m, h))
}
$jscomp.polyfillUnisolated = function (k, n, m, h) {
  ...
  n != h &&
    null != n &&
    $jscomp.defineProperty(m, k, { configurable: !0, writable: !0, value: n })
}
  ...
  function (k) {
    return k
      ...
      : function (n, m) {
          return (
            -1 !==
            $jscomp.checkStringArgs(this, n, 'includes').indexOf(n, m || 0)
          )
        }
  },
  'es6',
  ...
  function (k) {
    return k
      ...
      : function (n, m) {
          ...
          for (var v = 0; v < q && m < r; ) if (h[m++] != n[v++]) return !1
          return v >= q
        }
  },
  'es6',
...
;(function () {
  ...
  var h,
    ...
    q = (function () {
      ...
      c.prototype.updateArrows = function (a) {
        ...
        for (var b = 1; b < this.dom.value.length; b++)
          this.dom.inputCont.append(this.dom.value[b]),
            this.dom.value[b].trigger('dtsb-inserted')
          ...
          if (this.s.type.includes('date') || this.s.type.includes('time'))
            ...
            for (a = 0; a < this.s.value.length; a++)
              this.s.value[a] &&
                ...
                (this.s.value[a] = (0, window.moment)(
                  this.s.value[a],
                  this.s.dateFormat
            ...
            for (a = 0; a < this.s.value.length; a++)
              this.s.value[a] &&
                0 < this.s.value[a].length &&
                null ===
                  window.luxon.DateTime.fromFormat(
                    this.s.value[a],
                    this.s.dateFormat
                  ).invalid &&
                (this.s.value[a] = window.luxon.DateTime.fromFormat(
                  this.s.value[a],
                  this.s.dateFormat
      ...
      c.prototype.rebuild = function (a) {
        ...
        if (b) {
          ...
          for (
            var g = void 0, l = this.dom.condition.children('option'), p = 0;
            p < l.length;
            p++
          ) {
            var t = h(l[p])
            ...
            'string' === typeof a.condition
              ? (t.prop('selected', !0), (g = t.val()))
              : t.removeProp('selected')
          }
          this.s.condition = g
          if (void 0 !== this.s.condition) {
            ...
            for (p = 0; p < l.length; p++)
              (t = h(l[p])),
                t.val() !== this.s.condition && t.removeProp('selected')
            ...
            if (e.val() === a.dom.condition.val()) {
              ...
              for (f = a.dom.value; e < f.length; e++)
                (g = f[e]),
                  a.s.filled &&
                    void 0 !== g &&
                    0 !== a.dom.inputCont.has(g[0]).length &&
                    ((a.s.filled = !1), a.s.dt.draw(), a.setListeners())
      ...
      c.prototype._populateCondition = function () {
        ...
        if (0 === b) {
          ...
          if (void 0 !== d)
            if (
              ((b = d[e]),
              void 0 !== b.searchBuilderType && null !== b.searchBuilderType)
            )
              this.s.type = b.searchBuilderType
          ...
          for (var g = 0, l = Object.keys(f); g < l.length; g++) {
            var p = l[g]
            null !== f[p] &&
              (this.s.dt.page.info().serverSide &&
                f[p].init === c.initSelect &&
                ((b = d[e]),
                this.s.serverData && this.s.serverData[b.data]
                  ? ((f[p].init = c.initSelectSSP),
                    (f[p].inputValue = c.inputValueSelect),
                    (f[p].isInputValid = c.isInputValidSelect))
                  : ((f[p].init = c.initInput),
                    (f[p].inputValue = c.inputValueInput),
                    (f[p].isInputValid = c.isInputValidInput))),
              (this.s.conditions[p] = f[p]),
              (b = f[p].conditionName),
              'function' === typeof b && (b = b(this.s.dt, this.c.i18n)),
              a.push(
                h('<option>', { text: b, value: p })
          ...
          for (
            this.dom.condition
              ...
              .addClass(this.classes.italic),
              f = 0,
              g = Object.keys(this.s.conditions);
            f < g.length;
            f++
          )
            (p = g[f]),
              (b = this.s.conditions[p].conditionName),
              'function' === typeof b && (b = b(this.s.dt, this.c.i18n)),
              (p = h('<option>', { text: b, value: p })
                .addClass(this.classes.option)
                .addClass(this.classes.notItalic)),
        ...
        if (d[e].searchBuilder && d[e].searchBuilder.defaultCondition)
          if (
            ((d = d[e].searchBuilder.defaultCondition), 'number' === typeof d)
          )
            this.dom.condition.prop('selectedIndex', d),
              this.dom.condition.trigger('change')
          else {
            if ('string' === typeof d)
              for (e = 0; e < a.length; e++)
                for (
                  p = 0, f = Object.keys(this.s.conditions);
                  p < f.length;
                  p++
                )
                  if (
                    ((g = f[p]),
                    (b = this.s.conditions[g].conditionName),
                    ('string' === typeof b ? b : b(this.s.dt, this.c.i18n)) ===
                      a[e].text() && g === d)
                  ) {
                    this.dom.condition
                      .prop(
                        'selectedIndex',
                        this.dom.condition.children().toArray().indexOf(a[e][0])
                      )
        ...
        if (0 === this.s.dataPoints.length)
          this.s.dt.columns().every(function (g) {
            if (
              ...
              l ||
                ((l = a.s.dt.settings()[0].aoColumns[g]),
                (g = {
                  index: g,
                  origData: l.data,
                  text: (void 0 === l.searchBuilderTitle
                    ? l.sTitle
                    : l.searchBuilderTitle
                  ).replace(/(<([^>]+)>)/gi, '')
                }),
          ...
          for (
            var b = function (g) {
                d.s.dt.columns().every(function (p) {
                  ...
                  ;(void 0 === t.searchBuilderTitle
                    ? t.sTitle
                    : t.searchBuilderTitle
                  ).replace(/(<([^>]+)>)/gi, '') === g.text &&
                    ((g.index = p), (g.origData = t.data))
                })
                var l = h('<option>', {
      ...
      c.prototype._populateValue = function (a) {
        ...
        if (1 < e.length) for (f = 0; f < e.length; f++) h(e[f]).remove()
        void 0 !== a &&
          this.s.dt.columns().every(function (l) {
            b.s.dt.settings()[0].aoColumns[l].sTitle === a.data &&
              (b.s.dataIdx = l)
          })
        this.dom.value = [].concat(
      ...
      c.initSelect = function (a, b, d, e) {
        ...
        for (var t = [], A = [], F = 0; F < g.length; F++) {
          ...
          'array' === a.s.type &&
            ((z = Array.isArray(z) ? z : [z]), (y = Array.isArray(y) ? y : [y]))
          var H = function (u, x) {
            ...
            u = h('<option>', {
              ...
              .addClass(a.classes.option)
              .addClass(a.classes.notItalic)
              .html('string' === typeof x ? x.replace(/(<([^>]+)>)/gi, '') : x)
            x = u.val()
            ;-1 === t.indexOf(x) &&
              (t.push(x),
              A.push(u),
              ...
              null !== d &&
                u.val() === d[0] &&
                (u.prop('selected', !0),
                p.removeClass(c.classes.italic),
                a.dom.valueTitle.removeProp('selected')))
          }
          if (e) for (var D = 0; D < z.length; D++) H(z[D], y[D])
        ...
        A.sort(function (u, x) {
          if (
            ...
            return u.val() < x.val() ? -1 : u.val() > x.val() ? 1 : 0
          if ('num' === a.s.type || 'html-num' === a.s.type)
            return +u.val().replace(/(<([^>]+)>)/gi, '') <
              +x.val().replace(/(<([^>]+)>)/gi, '')
              ? -1
              : +u.val().replace(/(<([^>]+)>)/gi, '') >
                +x.val().replace(/(<([^>]+)>)/gi, '')
      ...
      c.initSelectSSP = function (a, b, d) {
        ...
        for (
          var f = [], g = 0, l = a.s.serverData[a.s.origData];
          g < l.length;
          g++
        ) {
          var p = l[g]
          ;(function (t, A) {
            ...
            null !== d &&
              t.val() === d[0] &&
              (t.prop('selected', !0),
              e.removeClass(c.classes.italic),
              a.dom.valueTitle.removeProp('selected'))
          })(p.value, p.label)
        }
      ...
      c.momentDateConditions = {
        '=': {
          ...
          search: function (a, b, d) {
            return (
              (0, window.moment)(a, d.s.dateFormat).valueOf() ===
              (0, window.moment)(b[0], d.s.dateFormat).valueOf()
            )
          }
        },
        '!=': {
      ...
      c.luxonDateConditions = {
        '=': {
          ...
          search: function (a, b, d) {
            return (
              window.luxon.DateTime.fromFormat(a, d.s.dateFormat).ts ===
              window.luxon.DateTime.fromFormat(b[0], d.s.dateFormat).ts
            )
          }
        },
        '!=': {
    ...
    E = (function () {
      ...
      c.prototype.setupLogic = function () {
        ...
        if (1 > this.s.criteria.length)
          ...
          a = this.dom.container.outerHeight() - 1
      ...
      c.prototype.addCriteria = function (a) {
        ...
        null !== a &&
          ((d.c = a.c),
          (d.s = a.s),
          (d.s.depth = this.s.depth),
          (d.classes = a.classes))
        d.populate()
        a = !1
        for (var e = 0; e < this.s.criteria.length; e++)
          0 === e && this.s.criteria[e].criteria.s.index > d.s.index
            ? (d
                .getNode()
                .insertBefore(this.s.criteria[e].criteria.dom.container),
              (a = !0))
            : e < this.s.criteria.length - 1 &&
              this.s.criteria[e].criteria.s.index < d.s.index &&
              this.s.criteria[e + 1].criteria.s.index > d.s.index &&
              (d
                .getNode()
                .insertAfter(this.s.criteria[e].criteria.dom.container),
              (a = !0))
        ...
        b = 0
        for (a = this.s.criteria; b < a.length; b++)
          (e = a[b]),
            e.criteria instanceof q &&
              e.criteria.updateArrows(1 < this.s.criteria.length)
      ...
      c.prototype.checkFilled = function () {
        for (var a = 0, b = this.s.criteria; a < b.length; a++) {
          var d = b[a]
          if (
            (d.criteria instanceof q && d.criteria.s.filled) ||
      ...
      c.prototype._andSearch = function (a, b) {
        ...
        for (var d = 0, e = this.s.criteria; d < e.length; d++) {
          ...
          if (
            !(
              (f.criteria instanceof q && !f.criteria.s.filled) ||
    ...
    G = (function () {
        ...
        if (void 0 === a.settings()[0]._searchBuilder) {
          ...
          this.s.dt.page.info().serverSide &&
            ...
            this.s.dt.on('xhr.dtsb', function (e, f, g) {
              g &&
                g.searchBuilder &&
                g.searchBuilder.options &&
                (d.s.serverData = g.searchBuilder.options)
            }))
      ...
      c.prototype._applyPreDefDefaults = function (a) {
        ...
        for (
          var d = function (l) {
              void 0 !== l.criteria
                ? (l = e._applyPreDefDefaults(l))
                : e.s.dt.columns().every(function (p) {
                    b.s.dt.settings()[0].aoColumns[p].sTitle === l.data &&
                      (l.dataIdx = p)
                  })
            },
            e = this,
      ...
      c.prototype._setUp = function (a) {
        var b = this
        void 0 === a && (a = !0)
        w.fn.DataTable.Api.registerPlural(
          'columns().type()',
          'column().type()',
          function () {
        ...
        if (!B.DateTime) {
          ...
          if (void 0 === d || d.includes(void 0) || d.includes(null))
            w.fn.dataTable.ext.oApi._fnColumnTypes(this.s.dt.settings()[0]),
        ...
        this.s.dt.on('preXhr.dtsb', function (l, p, t) {
          b.s.dt.page.info().serverSide &&
            (t.searchBuilder = b._collapseArray(b.getDetails(!0)))
        })
            ...
            ? (this.s.topGroup.rebuild(a.searchBuilder),
              ...
              this.s.dt.page.info().serverSide ||
                (a.page
                  ...
                  : this.s.dt.scroller &&
                    a.scroller &&
                    this.s.dt.scroller().scrollToRow(a.scroller.topRow)),
              this.s.topGroup.setListeners())
            : !1 !== this.c.preDefined &&
      ...
      c.prototype._build = function () {
        ...
        w.fn.dataTable.ext.search.includes(this.s.search) ||
        ...
        this.s.dt.on('destroy.dtsb', function () {
          ...
          for (
            var e = w.fn.dataTable.ext.search.indexOf(a.s.search);
            -1 !== e;

          )
            w.fn.dataTable.ext.search.splice(e, 1),
              (e = w.fn.dataTable.ext.search.indexOf(a.s.search))
          a.s.dt.off('.dtsb')
  ...
  ;(function (c) {
    ...
    c.fn.dataTable.ext.buttons.searchBuilder = {
      ...
      config: {},
      init: function (f, g, l) {
        var p = new c.fn.dataTable.SearchBuilder(
          f,
          c.extend(
            {
        ...
        f.button(g).text(
          l.text || f.i18n('searchBuilder.button', p.c.i18n.button, 0)
        )
        l._searchBuilder = p
      },
      text: null
